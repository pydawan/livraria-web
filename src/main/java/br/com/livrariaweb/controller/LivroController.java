    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!livros.isEmpty()) {
                ...
                // 1. O header Accept é configurado na requisição HTTP enviada pelo cliente e informa o tipo de dados
                // aceito (esperado) como resposta.
                // 2. O header Content-Type é configurado na resposta HTTP e informa o tipo de dados retornado para o
                // cliente.
                // 3. Accept informa o tipo de dados consumido e o Content-Type informa o tipo de dados produzido
                // (cliente/servidor).
